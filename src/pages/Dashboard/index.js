      ...
      >
          ...
          >
            <CardContent>
              <Typography color="textSecondary" variant="h5" gutterBottom>
                {intl.formatMessage({
                  id: 'registered_usres',
                  defaultMessage: 'Number of Data Entries',
                })}
              </Typography>
            </CardContent>
            <div
        ...
        >
          ...
          >
            ...
            >
              <CardContent>
            <a style={{color: 'orange'}} href="/public/healthcare-dataset-stroke-data.csv" download>DOWNLOAD THE DATA</a>
              </CardContent>
            </div>
          </Card>
        </div>
